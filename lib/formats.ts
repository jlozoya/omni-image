...
export const OUTPUT_FORMATS: FormatInfo[] = [
  ...
  { id: 'webp', label: 'WebP', extension: 'webp', mime: 'image/webp', lossy: true, qualityControl: true, alpha: true },
  {
    ...
    lossy: true,
    alpha: true,
    notes: 'WASM encoder; quality tuning can be added per codec preset',
  },
  {
    id: 'jxl',
    label: 'JPEG XL',
  ...
  },
  {
    ...
    lossy: false,
    alpha: true,
    notes: 'Static single-frame output',
  },
  ...
  { id: 'tga', label: 'TGA', extension: 'tga', mime: 'image/x-tga', lossy: false, alpha: true },
  {
    ...
    lossy: false,
    alpha: true,
    notes: 'Embeds the raster image; does not vectorize it',
  },
